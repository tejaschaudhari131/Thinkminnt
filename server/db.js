...
// Seed programs (Robust check)
const insertProgram = db.prepare('INSERT INTO programs (title, category, description, image, icon) VALUES (@title, @category, @description, @image, @icon)');
...
programs.forEach(program => {
  const existing = checkProgram.get(program.title);
  if (!existing) {
